"""
╔══════════════════════════════════════════════════════════════╗
║         FIBLAB ROBOT — Webhook Trading Server  (v2.7.32)     ║
...
def save_profile(chat_id: str, profile: dict):
    with db() as conn:
        conn.execute(
            ...
            "score_min,signals,tfs,tf_custom) VALUES (?,?,?,?,?,?,?,?,?,?,?) "
            ...
            "signals=excluded.signals, tfs=excluded.tfs, tf_custom=excluded.tf_custom",
